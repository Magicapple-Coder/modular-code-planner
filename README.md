...
An [Agent Skills](https://agentskills.io) package that stops your codebase from turning into one giant file.
...
Works with any agent that reads `SKILL.md`. No runtime dependency beyond Python 3.8+ for the scanner.
